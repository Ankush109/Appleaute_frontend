...
import { GetUserCartQuery, deleteCart } from "../api/cart";
import { toast } from "react-hot-toast";
import { AiTwotoneDelete } from "react-icons/ai";
function CartItem({ id, name, price, image, order }) {
  ...
  return (
    <div>
      <div className="bg-white flex mx-4 my-3 ">
        <div className="flex ">
          <div className=" p-2  ">
            <img
          ...
          <div className="my-6 mx-6">
            <h1 className=" text-bold font-bold">{name}</h1>
            <div class="flex items-center">
              <p class=" bg-green-600 p-2 rounded-lg text-sm font-bold text-gray-900 dark:text-white">
                4.5{" "}
            ...
            {!order ? (
              <button
                ...
                className="bg-red-500 p-2 my-5 rounded-2xl"
              >
